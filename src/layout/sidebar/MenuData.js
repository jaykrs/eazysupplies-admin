...
const MENUITEMS = [
  ...
  },
  {
    ...
    type: "sub",
    children: [
      { title: "AddSupplier", path: "/supplier/create", displayTitle: "Add Supplier", permission: ["supplier.create"] },
      { title: "AllSupplier", path: "/supplier", displayTitle: "Supplier List", permission: ["supplier.index"] }
    ],
  },
  {
    title: "Tax",
