...
const ShowDeliveryAgentTable = ({ current_page, per_page, mutate, isCheck, setIsCheck, url, sortBy, setSortBy, headerData, fetchStatus, moduleName, type, redirectLink, refetch, keyInPermission, link, fetchProduct = () => { } }) => {
    ...
    const handleEdit = (tableData) => {
        router.push('/deliveryAgent/edit/' + tableData?.id);
    }
        ...
        <>
            <div className="w-100 d-flex justify-content-end fs-5 py-3">
                <div className="w-50 d-flex justify-content-end gap-4">
                    ...
                    <button className="px-4 py-2 btn btn-primary fs-5" onClick={() => router.push("/deliveryAgent/create")} >Add</button>
                </div>
            </div>
...
export default ShowDeliveryAgentTable;
